...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        ###############################################################################################
         # NotImplementedError("Not Implemented function: __init__, class: linear_layer")
        ...
        self.gradient['W']= np.zeros((input_D,output_D),float)
        self.gradient['b']= np.zeros((1,output_D),float)
    ...
    def backward(self, X, grad):
        ...
        self.gradient['b'] = np.dot(np.ones((1, np.size(grad,0))),grad)
...
class tanh:
    ...
    def backward(self, X, grad):
        ...
        backward_output = np.multiply(1-np.square(np.tanh(X)), grad)
        ####################################################################################################
        # TODO: Implement the backward pass
